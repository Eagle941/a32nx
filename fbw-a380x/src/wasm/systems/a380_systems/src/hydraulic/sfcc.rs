...
impl SlatFlapControlComputer {
    ...
    fn flap_load_relief_active(&self, flaps_handle: &FlapsHandle) -> bool {
        flaps_handle.current_position() == CSU::Conf2 && self.config != FlapsConf::Conf2
            || flaps_handle.current_position() == CSU::Conf3 && self.config != FlapsConf::Conf3
    ...
    fn cruise_baulk_active(&self, flaps_handle: &FlapsHandle) -> bool {
        flaps_handle.current_position() == CSU::Conf1 && self.config == FlapsConf::Conf0
    }
