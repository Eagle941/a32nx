...
impl FlapsChannel {
    ...
    fn generate_configuration(&self, flaps_handle: &FlapsHandle, context: &UpdateContext) -> Angle {
    ...
    pub fn update(
        ...
        self.flaps_demanded_angle = self.generate_configuration(flaps_handle, context);
